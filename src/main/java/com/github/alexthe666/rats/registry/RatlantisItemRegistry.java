...
public class RatlantisItemRegistry {
	...
	public static final RegistryObject<Item> RAT_UPGRADE_BIPLANE_MOUNT = ITEMS.register("rat_upgrade_biplane_mount", () -> new BiplaneMountUpgradeItem(new Item.Properties()));
